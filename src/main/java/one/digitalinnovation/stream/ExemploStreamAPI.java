...
public class ExemploStreamAPI {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Todos os alementos tem o W no nome ? " + estudantes.stream().allMatch((elemento) -> elemento.contains("W")));
...
//                .collect(Collectors.groupingBy(estudande -> estudante.substring(estudante.indexOf("-") + 1)));
    }
}
